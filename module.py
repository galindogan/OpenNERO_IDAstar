...
#    ('Random Actions',          lambda: getMod().start_random(),        False, MODE_SEARCH | MODE_RL),
    ...
    ('ID A* Search ',         lambda: getMod().start_IdaStar(),        False, MODE_SEARCH),
...
#    ('Sarsa',                lambda: getMod().start_sarsa(),         True, MODE_RL),
    ...
    def start_IdaStar(self):
        """ start the Iterative A* search demo  """
        self.start_agent("data/shapes/character/SydneyIdaStarSearchAgent.xml", MazeEnvironment)
